...
func main() {
	...
	//			//serverHello.unmarshal(targetConnBuf[:n])
	//			//fmt.Println("serverHelloMsg alpnProtocol:", serverHello.alpnProtocol)
	//			//fmt.Println("serverHelloMsg cipherSuite:", serverHello.cipherSuite)
	//			//fmt.Println("serverHelloMsg compressionMethod:", serverHello.compressionMethod)
	//			//fmt.Println("serverHelloMsg nextProtoNeg:", serverHello.nextProtoNeg)
	//			//fmt.Println("serverHelloMsg nextProtos:", serverHello.nextProtos)
	//			//fmt.Println("serverHelloMsg ocspStapling:", serverHello.ocspStapling)
	//			//fmt.Println("serverHelloMsg secureRenegotiation:", serverHello.secureRenegotiation)
	//			//fmt.Println("serverHelloMsg secureRenegotiationSupported:", serverHello.secureRenegotiationSupported)
	//			//fmt.Println("serverHelloMsg sessionId:", serverHello.sessionId)
	//			//fmt.Println("serverHelloMsg ticketSupported:", serverHello.ticketSupported)
	//			//fmt.Println("serverHelloMsg vers:", serverHello.vers)
	//		}
	//		if n < BUFSIZE {
	//			break
	//		}
